...
export default {
	...
	created: function() {
		...
		//this.users = this.$store._mutations._getCustomer();
		this.items = [
			{'name': '笔', 'price': 10, 'amount': 0},
			{'name': '战网点', 'price': 30, 'amount': 0},
			{'name': '移动硬盘', 'price': 100, 'amount': 0}
		];
		this.users = [
			{'name': 'Imanity', 'address': '紫荆1＃412A', 'mobile': '13312345678', 'prices': 140, 'choose': [
				{'index': 0, 'amount': 1},
				{'index': 1, 'amount': 1},
				{'index': 2, 'amount': 1}
			]},
			{'name': 'Aslan', 'address': '紫荆1＃412B', 'mobile': '13312345678', 'prices': 70, 'choose': [
				{'index': 0, 'amount': 1},
				{'index': 1, 'amount': 2}
			]},
			{'name': 'Rowing', 'address': '紫荆1＃407B', 'mobile': '13312345678', 'prices': 120, 'choose': [
				{'index': 1, 'amount': 4}
			]},
		];
